...
<!--<link rel="stylesheet" type="text/css" href="css/librerias_css/onepage-scroll.css"> -->
	...
	<title>Bintech - Logistica y Transporte</title>
</head>
<body>

	<?php require_once "cabeceras/header.php"; ?>

	<img class="landing_page_background" src="img/logistica_transporte/fondo.png">
	...
	<img src="img/index/section3/Icon-Logistica y transporte.png" class="icon_industrias_menu" alt="">
