...
<!--<link rel="stylesheet" type="text/css" href="css/librerias_css/onepage-scroll.css"> -->
	...
	<title>Bintech - Salud y  hospitalidad</title>
</head>
<body>

	<?php require_once "cabeceras/header.php"; ?>

	<img class="landing_page_background" src="img/salud_hospitalidad/fondo.png">
	...
	<img src="img/index/section3/Icon-Salud y hospitalidad.png" class="icon_industrias_menu" alt="">
		...
		<div class="text_content" >
			<p>En Bintech hemos asesorado a Instituciones de salud públicas y privadas en diversos países. Somos pioneros en la institucionalización de modelos financieros de rentabilidad, gestión de costos y planeación vinculados. Utilizamos tecnología SAP EPM (Enterprise Performance Management) como se muestra a continuación.</p>
					...
					<ul>
						...
						<li>Cómo orientar mejor los recursos para optimizar la capacidad de la infraestructura.</li>
						<li>Cómo lograr una mayor transparencia de las operaciones para tener un mejor enfoque y capacidad de respuesta.</li>
					</ul>
